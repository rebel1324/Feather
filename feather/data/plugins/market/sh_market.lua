...
GM:AddShipment("smg", "weapon_smg1", 10, {TEAM_GUNDEALER}, "Sub Machinegun", "Firearms", "A Sub Machine Gun that fires bullets", "models/weapons/w_smg1.mdl", 2500)
GM:AddShipment("shotgun", "weapon_shotgun", 10, {TEAM_GUNDEALER}, "Shotgun", "Firearms", "A Shotgun that fires bullets", "models/weapons/w_shotgun.mdl", 4300)
GM:AddShipment("crowbar", "weapon_crowbar", 10, {TEAM_GUNDEALER, TEAM_MOBBOSS}, "Crowbar", "Melee", "A Metal Bar that really useful to break something.", "models/weapons/w_crowbar.mdl", 1000)
GM:AddShipment("stunstick", "weapon_stunstick", 10, {TEAM_GUNDEALER, TEAM_MAYOR, TEAM_POLICECHIEF}, "Stunstick", "Melee", "A Metal Bar that really useful to beat someone.", "models/weapons/w_stunbaton.mdl", 1800)

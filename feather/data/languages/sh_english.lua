...
l.arrestedhud = "You're arrested."
l.arrestedhudtime = "Your arrest will be lifed in %s."
...
l.hudsearchvictimname = "Someone is seaching you."
...
l.configsavedtip = "Modified configs are automatically saved in server's data folder."
l.configauthtip = "Only authorized person can edit server config."
l.configwarntip = "You can wipe server's config by pressing the button at the bottom."

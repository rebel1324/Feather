...
l.canhear = "People can hear you:"
l.andmore = "and %s more..."
l.jobfull = "That job is full."
l.propbanned = "That prop is banned from the server."
...
l.newmissions = "New missions are available."
l.garbageleft = "%s garbages left."
l.garbagebriefing = "You have to destroy %s grabages around the map in %s seconds."
l.garbagefail = "You failed to process all grabages around the map."
l.garbage = "Destroy"

l.scoreboardinfo = "Right Click to player's name to bring player interaction menu."
l.scoreboardcredit = "A Simple Roleplay Script by Black Tea Za rebel1324, Chessnut." 

l.menu = "Menu"
l.menujob = "Job"
l.menushop = "Shop"
l.menuinventory = "Inventory"
l.menuconfig = "Config"
l.menuclose = "Close"
...
l.wantstobe = "%s 님이 %s 직업이 되고 싶어합니다."
...
l.canhear = "채팅을 볼 수 있는 사람:"
l.andmore = "그리고 %s명 더..."
l.jobfull = "그 직업의 최대 인원이 찼습니다."
l.modify_button = "수정"
l.purchase_button = "구매"
l.close_button = "닫기"
l.propbanned = "이 프롭은 서버에서 금지한 프롭입니다."
l.bigpropwait = "%s초 뒤에 다음 프롭을 소환 할 수 있습니다."
l.toobigprop = "그 프롭은 소환하기에 너무 큽니다."
...
l.newmissions = "새로운 임무가 있습니다."
l.garbageleft = "%s개의 쓰레기가 남았습니다."
l.garbagebriefing = "맵 전체에 흩어져 있는 %s개의 쓰레기들을 찾아 %s초 안에 파괴하십시오."
l.garbagefail = "쓰레기를 처리하는데에 실패하였습니다."
l.garbage = "파괴"

l.scoreboardinfo = "오른쪽 클릭으로 플레이어 메뉴를 열 수 있습니다."
l.scoreboardcredit = "매우 간단하고 빠른 인생살기 스크립트 - Black Tea Za rebel1324, Chessnut." 
